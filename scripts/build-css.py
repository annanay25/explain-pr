...
.fig-scene-tab:hover {{
  border-color: var(--fig-rule);
  background: #fff;
  color: var(--fig-ink);
}}
.fig-scene-tab.is-current,
.fig-scene-tab[aria-current="page"] {{
  border-color: var(--fig-ink);
  background: var(--fig-ink);
  color: var(--fig-paper);
}}
...
.fig-scene-tab strong {{
  font-size: 13px;
  font-weight: 550;
  line-height: 1.25;
}}
.fig-walk .fig-view-tabs {{ display: none; }}
...
.fig-gloss {{
  ...
  border-radius: 2px;
  background: color-mix(in srgb, var(--fig-changed-bg) 80%, white);
  color: inherit;
  font: inherit;
  line-height: inherit;
  cursor: pointer;
}}
.fig-gloss-dock {{ display: none; }}
.fig-canvas {{
  flex: 1;
  display: flex;
  flex-direction: column;
...
.fig-mermaid svg .messageLine0,
.fig-mermaid svg .messageLine1 {{
  stroke: var(--fig-ink) !important;
  stroke-width: 1.75px !important;
}}
.fig-mermaid svg marker path {{
  fill: var(--fig-ink) !important;
  stroke: var(--fig-ink) !important;
}}
.fig-mermaid svg .sequenceNumber {{
  fill: #fffaf2 !important;
  font-family: "IBM Plex Mono", ui-monospace, monospace !important;
  font-size: 12px !important;
  font-weight: 600;
}}
.fig-mermaid svg marker[id$="-sequencenumber"] circle {{
  r: 7px;
  fill: var(--fig-focus) !important;
...
.fig-pane .fig-callout {{
  max-width: none;
  margin: 0;
}}
.fig-compare > .fig-pane:has(.fig-code) {{
  flex: 1.55 1 360px;
}}
.fig-pane::before {{
  content: attr(data-label);
...
.fig-node[data-kind="type"] > summary,
.fig-node[data-kind="fn"] > summary,
.fig-node[data-kind="var"] > summary {{
  grid-template-columns: 48px minmax(0, 1fr) auto;
}}
.fig-node.tight[data-kind="type"] > summary,
.fig-node.tight[data-kind="fn"] > summary,
.fig-node.tight[data-kind="var"] > summary {{
  grid-template-columns: 40px minmax(0, 1fr) auto;
}}
.fig-node[data-kind="type"] > summary::after,
.fig-node[data-kind="fn"] > summary::after,
.fig-node[data-kind="var"] > summary::after {{
  content: "existed";
  align-self: start;
  margin-top: 2px;
  font-family: "IBM Plex Mono", ui-monospace, monospace;
...
.fig-node[data-kind="type"][data-tone="added"] > summary::after,
.fig-node[data-kind="fn"][data-tone="added"] > summary::after,
.fig-node[data-kind="var"][data-tone="added"] > summary::after {{
  content: "new";
  color: var(--fig-added);
  border-color: color-mix(in srgb, var(--fig-added) 40%, white);
  background: var(--fig-added-bg);
}}
.fig-node[data-kind="type"][data-tone="changed"] > summary::after,
.fig-node[data-kind="fn"][data-tone="changed"] > summary::after,
.fig-node[data-kind="var"][data-tone="changed"] > summary::after,
.fig-node[data-kind="type"][data-tone="focus"] > summary::after,
.fig-node[data-kind="fn"][data-tone="focus"] > summary::after,
.fig-node[data-kind="var"][data-tone="focus"] > summary::after {{
  content: "changed";
  color: var(--fig-changed);
  border-color: color-mix(in srgb, var(--fig-changed) 40%, white);
  background: var(--fig-changed-bg);
}}
.fig-node[data-kind="type"][data-tone="removed"] > summary::after,
.fig-node[data-kind="fn"][data-tone="removed"] > summary::after,
.fig-node[data-kind="var"][data-tone="removed"] > summary::after {{
  content: "removed";
  color: var(--fig-removed);
  border-color: color-mix(in srgb, var(--fig-removed) 40%, white);
  background: var(--fig-removed-bg);
}}
.fig-node[data-kind="type"][data-tone="ghost"] > summary::after,
.fig-node[data-kind="fn"][data-tone="ghost"] > summary::after,
.fig-node[data-kind="var"][data-tone="ghost"] > summary::after {{
  content: "existed";
}}
.fig-node[data-kind="type"][data-tone="added"],
.fig-node[data-kind="fn"][data-tone="added"],
.fig-node[data-kind="var"][data-tone="added"] {{
  background: color-mix(in srgb, var(--fig-added-bg) 45%, #fffaf2);
}}
.fig-node[data-kind="type"][data-tone="changed"],
.fig-node[data-kind="fn"][data-tone="changed"],
.fig-node[data-kind="var"][data-tone="changed"] {{
  background: color-mix(in srgb, var(--fig-changed-bg) 40%, #fffaf2);
}}
.fig-node[data-kind="type"][data-tone="removed"],
.fig-node[data-kind="fn"][data-tone="removed"],
.fig-node[data-kind="var"][data-tone="removed"] {{
  background: color-mix(in srgb, var(--fig-removed-bg) 40%, #fffaf2);
}}
...
@media (max-width: 700px) {{
  ...
  .fig-deck {{ width: calc(100% - 24px); margin-top: 16px; }}
  .fig-node {{ width: 100%; }}
  .fig-node.tight {{ width: 100%; }}
  .fig-view-tabs {{ padding-left: 16px; padding-right: 16px; }}
  .fig-walk {{ grid-template-columns: 1fr; }}
  .fig-scene-tabs {{
    flex-direction: row;
    overflow-x: auto;
    padding: 10px 12px;
  ...
  .fig-scene-tabs-title {{ display: none; }}
  .fig-scene-tab {{ min-width: 180px; }}
}}
"""
